...
function js() {
  ...
  return _gulp2.default.src(paths.js.src).
    pipe((0, _gulpConcat2.default)('main.js')).
    //pipe((0, _gulpHash2.default)()).
    pipe(_babel()).
    
    pipe(_gulp2.default.dest(paths.js.stat)).
    _browserify({
      entries: 'static/js/main.js',
      debug: false
    })
    .bundle().
    pipe(_gulpHash2.default.manifest("hash.json")).
    pipe(_gulp2.default.dest(paths.js.dest));
}
...
function cnbabel() {
  return _gulp2.default.src("src/js/main.js")
    .pipe(_babel())
...
var js = exports.cnbabel = _gulp2.default.series(js);
